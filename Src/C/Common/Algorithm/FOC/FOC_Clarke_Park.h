...
#ifndef FOC_CLARKE_PARK_H
#define FOC_CLARKE_PARK_H

#include "FOC_Type.h"

Curr_Components ST_Clarke(Curr_Components Curr_Input);
Curr_Components ST_Park(Curr_Components Curr_Input, Sin_Cos_Value SinCosMap);
Volt_Components ST_Rev_Park(Volt_Components Volt_Input, Sin_Cos_Value SinCosMap);
